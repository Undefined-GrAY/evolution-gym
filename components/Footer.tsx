...
export default function Footer() {
  return (
    <footer className="bg-[#151618] text-white w-full pt-20 pb-12 px-6 sm:px-12 border-t border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-20 relative z-10">
        ...
        <div className="md:col-span-1 flex flex-col justify-between">
          ...
          <button
            ...
            className="w-fit bg-white text-[#2A2A2D] px-6 py-3 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-[#E4E8F1] transition-all flex items-center gap-2"
          >
        ...
        {/* Quick Links Column */}
        <div>
          <h4 className="text-xs uppercase tracking-widest font-bold text-[#63739A] mb-6">Explore</h4>
        ...
        <div>
          <h4 className="text-xs uppercase tracking-widest font-bold text-[#63739A] mb-6">Hours & Access</h4>
          <div className="flex flex-col gap-3 text-sm text-white/80 font-light">
            <p><strong className="font-semibold text-white">Mon – Fri:</strong> 06:00 AM – 11:00 PM</p>
            <p><strong className="font-semibold text-white">Sat – Sun:</strong> 07:00 AM – 10:00 PM</p>
            <p><strong className="font-semibold text-white">Thermal SPA:</strong> 08:00 AM – 10:00 PM</p>
            <p className="text-xs text-white/50 pt-2">Biometric keycard required for off-peak access.</p>
          </div>
        </div>

        {/* Newsletter & Socials */}
        <div>
          <h4 className="text-xs uppercase tracking-widest font-bold text-[#63739A] mb-6">Stay Connected</h4>
          <p className="text-xs text-white/70 mb-4">Subscribe for schedule drops and exclusive private masterclasses.</p>
          <div className="flex items-center bg-white/10 border border-white/15 rounded-full p-1 mb-6">
            ...
            />
            <button className="bg-white text-[#2A2A2D] rounded-full p-2 hover:bg-gray-200 transition-colors">
              <ArrowUpRight className="w-4 h-4" />
            </button>
          </div>
      ...
      <div className="max-w-7xl mx-auto pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center text-xs text-white/40 gap-4 relative z-10">
        <p>© {new Date().getFullYear()} EVOLUTION Fitness Club. All Rights Reserved.</p>
        <div className="flex items-center gap-6">
          <a href="#" className="hover:text-white/80 transition-colors">Privacy Policy</a>
          <a href="#" className="hover:text-white/80 transition-colors">Terms of Membership</a>
          <a href="#" className="hover:text-white/80 transition-colors">Club Rules</a>
        </div>
      </div>
    </footer>
  );
